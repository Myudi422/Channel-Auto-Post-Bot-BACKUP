...
FILTER_TEXT = bool(os.environ.get("FILTER_TEXT", False))
FILTER_AUDIO = bool(os.environ.get("FILTER_AUDIO", True))
FILTER_DOCUMENT = bool(os.environ.get("FILTER_DOCUMENT", False))
FILTER_PHOTO = bool(os.environ.get("FILTER_PHOTO", False))
FILTER_STICKER = bool(os.environ.get("FILTER_STICKER", False))
FILTER_VIDEO = bool(os.environ.get("FILTER_VIDEO", True))
FILTER_ANIMATION = bool(os.environ.get("FILTER_ANIMATION", False))
FILTER_VOICE = bool(os.environ.get("FILTER_VOICE", False))
FILTER_VIDEO_NOTE = bool(os.environ.get("FILTER_VIDEO_NOTE", False))
FILTER_CONTACT = bool(os.environ.get("FILTER_CONTACT", False))
FILTER_LOCATION = bool(os.environ.get("FILTER_LOCATION", False))
FILTER_VENUE = bool(os.environ.get("FILTER_VENUE", False))
FILTER_POLL = bool(os.environ.get("FILTER_POLL", False))
FILTER_GAME = bool(os.environ.get("FILTER_GAME", False))
